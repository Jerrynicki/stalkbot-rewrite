...
os.system("py -m pip install pygame discord.py Pillow gTTS win10toast --user")
...
cam_width = input("Please input the width of your webcam (px): ")
cam_height = input("Please input the height of your webcam (px): ")
webcam_delay = input("Please input the desired delay before taking a picture when the webcam command is used: ")
screenshot_blur = input("Please input the desired amount of blur when taking screenshots: ")
timeout = input("Please input the cooldown/timeout for commands: ")
...
max_message_length = input("Please input the maximum length for tts/play commands: ")
